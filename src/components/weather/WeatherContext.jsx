    ...
    return (
        <div className='w-full h-[98%] overflow-y-auto flex flex-col sm:flex-row text-white'>
            ...
            <div className='sm:w-[30%] w-full h-auto flex flex-col'>
                ...
                <div className='w-full h-auto flex justify-between mt-8'>
                    <input
                        ...
                        className="w-2/3 h-10 text-sm shadow-lg text-gray-200 bg-black px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-red-500"
                    />
                    <div onClick={throughCity} className='cursor-pointer pt-2 pb-2 font-extrabold pl-3 pr-3 text-sm border bg-gray-700 hover:shadow-lg hover:shadow-white border-white rounded-lg hover:bg-white hover:text-black hover:font-bold'>SEARCH</div>
                </div>
                ...
                <div className='w-full h-[250px] relative rounded'>
                    ...
                    <div className='w-full p-2 h-full flex flex-col rounded relative shadow-lg hover:shadow-gray-800'>
                        ...
                        <h2 className="text-gray-700 absolute mt-12 pointer-events-none">
                            {weather?.main?.temp
                        ...
                        {weather?.weather?.[0]?.icon && (
                            <img
                                ...
                                className="absolute ml-36 w-[60%] sm:mt-[-30px] mt-0 pointer-events-none invert"
                                alt="Weather Icon"
                            />
                        )}
            ...
            <div className='sm:w-[78%] w-full h-auto sm:sm:h-full flex flex-col items-center justify-center'>
                <div className="w-full h-auto pl-2 pr-2 pb-0 mb-0 text-5xl flex items-center justify-center bg-clip-text text-gray-800 bg-gradient-to-b from-neutral-50 to-neutral-400">WEATHER</div>
                <hr className="h-px my-4 border-0 bg-gray-800"></hr>

                <div className='font-bold text-3xl h-[55px] w-full bg-clip-text text-gray-800 bg-gradient-to-b from-neutral-50 to-neutral-500'>
                    Today's Highlights
                </div>
                <div className='w-full h-auto flex flex-col sm:flex-row mb-3 sm:mb-0'>
                    <div className='w-full sm:w-[49%] h-[300px] relative rounded'>
                        <div className='w-full h-full bg-[#faf0e6] border-solid border-2 border-gray-500 absolute opacity-40 rounded'></div>
                        <div className='w-full p-2 h-full relative rounded shadow-lg hover:shadow-gray-800'>
                            <div className='font-bold absolute opacity-60 text-xl h-full flex items-start justify-between tracking-normal hover:tracking-wider transition-all duration-300 hover:text-red-500 pl-1 w-full bg-clip-text text-gray-800 bg-gradient-to-b from-neutral-50 to-neutral-500'>
                                Air Quality Index
                    ...
                    <div className='w-full sm:w-[49%] h-[300px] relative rounded'>
                        <div className='w-full h-full bg-[#faf0e6] border-solid border-2 border-gray-500 border-solid border-2 border-gray-500 absolute opacity-40 rounded '></div>
                        <div className='w-full p-2 h-full relative rounded shadow-lg hover:shadow-gray-800'>
                            <div className='font-bold absolute opacity-60 text-xl h-full tracking-normal hover:tracking-wider transition-all duration-300 hover:text-red-500 pl-1 w-full bg-clip-text text-gray-800 bg-gradient-to-b from-neutral-50 to-neutral-500'>Sunrise & Sunset</div>
                            <div className="flex items-end justify-center h-full w-full">
                                <div className="w-[45%] h-[70%] sm:h-[80%] flex flex-col items-center justify-between">
                                    <img src={SR} className="invert w-2/3" alt="" />
                                    <div className="text-gray-700 text-3xl">SUNRISE</div>
                                    <div className="text-xl text-gray-500">{unixConvert(weather.sys.sunrise).toLocaleTimeString()}</div>
                                </div>
                                <div className="w-[45%] h-[70%] sm:h-[80%] flex flex-col items-center justify-between">
                                    <img src={SS} className="invert w-3/5" alt="" />
                                    <div className="text-gray-700 text-3xl">SUNSET</div>
                ...
                <div className="sm:w-[98%] w-full sm:h-[150px] h-[350px] grid sm:grid-cols-5 grid-cols-2 gap-4">
                    <div className='relative rounded'>
                        <div className='bg-[#faf0e6] border-solid border-2 border-gray-500  w-full h-full absolute opacity-40 rounded'></div>
                        <div className='p-2 relative w-full h-full rounded shadow-lg hover:shadow-gray-800'>
                            <div className='font-bold absolute opacity-60 text-xl h-full tracking-normal hover:tracking-wider transition-all duration-300 hover:text-red-500 pl-1 w-full bg-clip-text text-gray-800 bg-gradient-to-b from-neutral-50 to-neutral-500'>Humidity</div>
                            <div className="w-full mt-2 sm:mt-0 h-full flex items-center justify-between">
                                <img src={H} className="w-10 invert" alt="" />
                                <div className="flex text-gray-700  text-3xl items-center justify-center">
                    ...
                    <div className='relative rounded'>
                        <div className='bg-[#faf0e6] border-solid border-2 border-gray-500 w-full h-full absolute opacity-40 rounded'></div>
                        <div className='p-2 relative w-full h-full rounded shadow-lg hover:shadow-gray-800'>
                            <div className='font-bold absolute opacity-60 text-xl h-full tracking-normal hover:tracking-wider transition-all duration-300 hover:text-red-500 pl-1 w-full bg-clip-text text-gray-800 bg-gradient-to-b from-neutral-50 to-neutral-500'>Wind Speed</div>
                            <div className="w-full mt-2 sm:mt-0 h-full flex items-center justify-between">
                                <img src={Vl} className="w-10 invert" alt="" />
                                <div className="flex text-gray-700 text-2xl items-center justify-center">
                    ...
                    <div className='relative rounded'>
                        <div className='bg-[#faf0e6] border-solid border-2 border-gray-500 w-full h-full absolute opacity-40 rounded'></div>
                        <div className='p-2 relative w-full h-full rounded shadow-lg hover:shadow-gray-800'>
                            <div className='font-bold absolute opacity-60 text-xl h-full tracking-normal hover:tracking-wider transition-all duration-300 hover:text-red-500 pl-1 w-full bg-clip-text text-gray-800 bg-gradient-to-b from-neutral-50 to-neutral-500'>Pressure</div>
                            <div className="w-full mt-2 sm:mt-0 h-full flex items-center justify-between">
                                <img src={P} className="w-10 invert" alt="" />
                                <div className="flex text-gray-700 text-2xl items-center justify-center">
                    ...
                    <div className='relative rounded'>
                        <div className='bg-[#faf0e6] border-solid border-2 border-gray-500 w-full h-full absolute opacity-40 rounded'></div>
                        <div className='p-2 relative w-full h-full rounded shadow-lg hover:shadow-gray-800'>
                            <div className='font-bold absolute opacity-60 text-xl h-full tracking-normal hover:tracking-wider transition-all duration-300 hover:text-red-500 pl-1 w-full bg-clip-text text-gray-800 bg-gradient-to-b from-neutral-50 to-neutral-500'>Visibility</div>
                            <div className="w-full mt-2 sm:mt-0 h-full flex items-center justify-between">
                                <img src={V} className="w-10 invert" alt="" />
                                <div className="flex text-gray-700 text-3xl items-center justify-center">
                    ...
                    <div className='relative rounded'>
                        <div className='bg-[#faf0e6] border-solid border-2 border-gray-500 w-full h-full absolute opacity-40 rounded'></div>
                        <div className='p-2 relative w-full h-full rounded shadow-lg hover:shadow-gray-800'>
                            <div className='font-bold absolute opacity-60 text-xl h-full tracking-normal hover:tracking-wider transition-all duration-300 hover:text-red-500 pl-1 w-full bg-clip-text text-gray-800 bg-gradient-to-b from-neutral-50 to-neutral-500'>Feels Like</div>
                            <div className="w-full mt-2 sm:mt-0 h-full flex items-center justify-between">
                                <img src={T} className="w-10 invert" alt="" />
                                <div className="flex text-gray-700 text-2xl items-center justify-center">
